...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        Movimientos movimientos = new Gson().fromJson(movimientoJson, Movimientos.class);

        // Add a marker in Sydney and move the camera
        LatLng sydney = new LatLng(movimientos.latitud, movimientos.longitud);
        mMap.addMarker(new MarkerOptions().position(sydney).title(movimientos.motivo));
